  ...
  return {
    content: [{
      ...
      text: JSON.stringify({
        ...
        message: `Trace logged. Use hanuman_trace_get with trace_id="${result.traceId}" to explore dig points.`
      }, null, 2)
    }]
  };
}
